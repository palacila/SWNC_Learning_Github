...
We will practice pulling and pushing by using another learner's branch. To avoid confusion from duplication, we will assign each of you a different learner's branch to pull from. See the chat for your assignment.
